...
class ContactPageController extends Controller
{
    ...
    public function index()
    {
        ...
        $contactData = ContactPage::orderBy('id', 'desc')->get();
    ...
    public function restore($id)
{
    try {
        ...
        $restoredCount = ContactPage::whereIn('id', $ids)->where('deleted_at', 1)->update(['deleted_at' => 0]);

        if ($restoredCount > 0) {
            return response()->json([
                'status' => true,
                'code' => '200',
                'message' => 'Contact Page Data Restored Successfully',
            ...
            return response()->json([
                'status' => false,
                'code' => '404',
                'message' => 'No Contact Page Found To Restore',
            ], 404);
        }
    } catch (\Exception $e) {
        return response()->json([
