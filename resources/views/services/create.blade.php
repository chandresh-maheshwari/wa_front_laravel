                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="title">Add Services</h5>
                            </div>
                            ...
                            <div class="card-body">
                                <form method="post" action='#' enctype="multipart/form-data" id="servicesForm">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-12 pr-1">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="service_title"
                                                    id="service_title" autocomplete="off">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea rows="4" cols="80" class="form-control" class="description"
                                    ...
                                    <div class="row">
                                        <div class="col-11">
                                            ...
                                            <a href="{{ url('/service_list') }}"><button type="button"
                            ...
                            <div class="row">
                                <div class="col-md-6 pr-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="period_by_cn" id="period_by_cn"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <!-- <input type="text" class="form-control" placeholder="" name="period_to" id="period_to"> -->
                                        <input type="text" class="form-control" name="period_to_cn" id="period_to_cn"
                                            required autocomplete="off">
                ...
                $('#servicesForm').submit(function(e) {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            if (data.success) {
                                swal('Services saved successfully', '', 'success');
